        ...
        <MainCard sx={{ p: 1.5 }}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} lg={4}>
              ...
              <Typography variant="h6">{userContext?.user?.client?.organization?.headquarter}</Typography>
            </Grid>
            <Grid item xs={12} lg={4}>
            ...
            <Grid item xs={12} lg={4}>
              ...
              <Typography variant="h6">{userContext?.user?.client?.organization?.specialists}</Typography>
            </Grid>
            <Grid item xs={12} lg={4}>
