      ...
      <Grid container spacing={3} sx={{ marginTop: '1vh' }}>
          ...
          <Grid container sx={{ display: 'flex', justifyContent: 'space-between' }} spacing={5}>
            ...
            <Grid item xs={6} sx={{ display: 'flex', justifyContent: 'flex-end' }}>
              <Button
                ...
                style={{ color: 'white', backgroundColor: theme.palette.primary.darker, width: '20%', borderRadius: '10px' }}
              >
                Post a New Job
              </Button>
            </Grid>
        ...
        <Grid item xs={9}>
          <Grid container spacing={5}>
            ...
            <Grid item lg={4} md={4} sm={6} xs={12}>
              <ActiveProjectsCard title={'Proposals Received'} value={0} handleClick={() => navigate('/client/proposals')} />
            </Grid>
            <Grid item lg={4} md={4} sm={6} xs={12}>
              <ActiveProjectsCard
              ...
              <Card sx={{ width: '100%' }}>
                <CardContent>
                  <Grid container sx={{ padding: '5px' }}>
                    <Grid item xs={3}>
                      <Typography variant="body2" sx={{ whiteSpace: 'nowrap', marginLeft: '1vw' }}>
                        Project Title
                      </Typography>
                    </Grid>
                    <Grid item xs={1}>
