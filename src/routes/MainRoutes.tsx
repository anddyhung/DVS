...
const JobPostStep2 = Loadable(lazy(() => import('pages/client/jobs/job-post-2')));
const JobPostStep3 = Loadable(lazy(() => import('pages/client/jobs/job-post-3')));
...
const MyContent = Loadable(lazy(() => import('pages/expert/mycontent')));
const UserSettings = Loadable(lazy(() => import('pages/expert/usersettings')));
...
const ESupportCenter = Loadable(lazy(() => import('pages/expert/supportcenter')));
  ...
  children: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          path: 'job-post-step2',
          element: <JobPostStep2 />
        },
        {
          path: 'job-post-step3',
          element: <JobPostStep3 />
        },
        {
