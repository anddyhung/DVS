              ...
              <Grid container spacing={3}>
                <Grid item xs={12}>
                  <Stack direction={'row'}>
                    ...
                    />
                    <Typography variant="body2">{props.expert.verifiedStatus}</Typography>
                  </Stack>
                </Grid>
                <Grid item xs={12}>
                  <Stack direction={'row'}>
                    <BusinessCenter
                      sx={{ backgroundColor: theme.palette.primary.dark, color: theme.palette.secondary.lighter, marginRight: '1vw' }}
                    />
                    <Typography variant="body2">{props.expert.organization}</Typography>
                  </Stack>
                </Grid>
                <Grid item xs={12}>
                  <Stack direction={'row'}>
                    <Poll
                      sx={{ backgroundColor: theme.palette.primary.dark, color: theme.palette.secondary.lighter, marginRight: '1vw' }}
                    />
                    <Typography variant="body2">{props.expert.jobCompleteness}</Typography>
                  </Stack>
                </Grid>
                <Grid item xs={12}>
                  <Stack direction={'row'}>
                    <StarRounded
                      sx={{ backgroundColor: theme.palette.primary.dark, color: theme.palette.secondary.lighter, marginRight: '1vw' }}
                    />
                    <Typography variant="body2">{props.expert.review}</Typography>
                  </Stack>
                </Grid>
                <Grid item xs={12}>
                  <Stack direction={'row'}>
                    <PinDrop
                      sx={{ backgroundColor: theme.palette.primary.dark, color: theme.palette.secondary.lighter, marginRight: '1vw' }}
                    />
                    <Typography variant="body2">{props.expert.country}</Typography>
                  </Stack>
                </Grid>
                <Grid item xs={12}>
                  <CardActions
